...
from GASP_steps import run_circuit, select_gene, create_individual, create_population, individual_to_circuit, calculate_fitness, crossover, mutate, circuit_to_individual, roulette_wheel_select_single, roulette_wheel_selection, breed_to_minimum, calculate_mod_fitness, get_fitness, get_mult_fitness, get_weight_fitness
...
def run_experiment(circuit_depth=7, checkpoint_path=None, save_every=10, experiment_name="gasp_experiment", num_circuits_to_save=100):
    ...
    # while iterations_since_improvement < maxiter and max_fitness_overall < desired_fitness:
        ...
        for individual in tqdm(population):
            ...
            fitness = get_weight_fitness(individual)
