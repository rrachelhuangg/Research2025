...
def optimize_angles(individual):
    circuit, param_list = individual_to_parameterized_circuit(individual, 22)
    ...
    bound_circuit = circuit.assign_parameters(param_dict)                                                                    
    return_fitness = calculate_fitness(bound_circuit)                                                                        
